...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Playground Métricas Boss</title>
        <meta
          name="description"
          content="Playground para testar disparos de tags no Google Tag Manager"
        />
      </Head>
          ...
          <div className="flex">
            <div>
              ...
              <p className="my-5 text-xl 4xl:text-lead text-gray-600 dark:text-gray-400">
                O Playground Métricas Boss é uma ferramenta interativa para
                testar disparos de tags no Google Tag Manager (GTM). Siga as
                etapas abaixo para utilizá-lo:
              </p>
            </div>
          </div>
